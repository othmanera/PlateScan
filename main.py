...
while ret:
    ...
    if ret and frame_nbr>10:
        ...
        # tracking vehicules
        track_ids = vehicule_tracker.update(np.asarray((detections_)))
        ...
        # assign a license plate to a tracked vehicule
        xcar1,ycar2,xcar2,ycar2,car_id = getCar((license_plate,track_ids))
